import{_ as a,c as s,o as n,aS as t}from"./chunks/framework.BItddkxz.js";const m=JSON.parse('{"title":"PlantUML","description":"","frontmatter":{"aside":"right","order":0},"headers":[],"relativePath":"design/uml/plantuml/index.md","filePath":"design/uml/plantuml/index.md","lastUpdated":1772792710000}'),p={name:"design/uml/plantuml/index.md"},e=t(`<h1 id="plantuml" tabindex="-1">PlantUML <a class="header-anchor" href="#plantuml" aria-label="Permalink to &quot;PlantUML&quot;">​</a></h1><p>官网地址：<a href="https://plantuml.com/zh/" target="_blank" rel="noreferrer">https://plantuml.com/zh/</a></p><p>PlantUML 是一款用文本描述生成 UML 图的工具，支持序列图、用例图、类图、活动图、状态图等。语法简洁，可与多种文档/维基/博客集成，也可通过官方或第三方服务生成图片链接嵌入页面。</p><p>在线服务器：<a href="https://www.plantuml.com/plantuml" target="_blank" rel="noreferrer">https://www.plantuml.com/plantuml</a>（将源码编码后放入 <code>/svg/</code> 或 <code>/png/</code> 路径即可生成图片）</p><h2 id="示例1-官方-svg-链接-markdown-图片语法" tabindex="-1">示例1：官方 SVG 链接（Markdown 图片语法） <a class="header-anchor" href="#示例1-官方-svg-链接-markdown-图片语法" aria-label="Permalink to &quot;示例1：官方 SVG 链接（Markdown 图片语法）&quot;">​</a></h2><h3 id="效果" tabindex="-1">效果 <a class="header-anchor" href="#效果" aria-label="Permalink to &quot;效果&quot;">​</a></h3><p><img src="https://www.plantuml.com/plantuml/svg/SoWkIImgAStDuNBAJrBGjLDmpCbCJbMmKiX8pSd9vt98pKi1IW80" alt=""></p><h3 id="代码" tabindex="-1">代码 <a class="header-anchor" href="#代码" aria-label="Permalink to &quot;代码&quot;">​</a></h3><div class="language-markdown vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">markdown</span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">![](</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;--shiki-light-text-decoration:underline;--shiki-dark-text-decoration:underline;">https://www.plantuml.com/plantuml/svg/SoWkIImgAStDuNBAJrBGjLDmpCbCJbMmKiX8pSd9vt98pKi1IW80</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">)</span></span></code></pre></div><div class="tip custom-block"><p class="custom-block-title">说明</p><p>URL 中的长字符串是 PlantUML 源码的编码结果，可在 <a href="https://www.plantuml.com/plantuml/uml" target="_blank" rel="noreferrer">PlantUML 在线编辑器</a> 中编写源码并获取编码后的链接。</p></div><h2 id="示例2-官方-svg-链接-html-img-标签" tabindex="-1">示例2：官方 SVG 链接（HTML img 标签） <a class="header-anchor" href="#示例2-官方-svg-链接-html-img-标签" aria-label="Permalink to &quot;示例2：官方 SVG 链接（HTML img 标签）&quot;">​</a></h2><h3 id="效果-1" tabindex="-1">效果 <a class="header-anchor" href="#效果-1" aria-label="Permalink to &quot;效果&quot;">​</a></h3><img src="https://www.plantuml.com/plantuml/svg/RSx12O8n38RXUwV80bb0HFuwWXl4Dc2X9jga-nliGP2Uy_3cEynf-7psb7ih37Y1gzvFaAS_MBmLygO2DtvFDaznCwg0mRv-0-sbOfnMZwp-ag911z0-lVwV4V_rld-mr9Zz0G00"><h3 id="代码-1" tabindex="-1">代码 <a class="header-anchor" href="#代码-1" aria-label="Permalink to &quot;代码&quot;">​</a></h3><div class="language-html vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">html</span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">&lt;</span><span style="--shiki-light:#22863A;--shiki-dark:#85E89D;">img</span><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;"> src</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">=</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;">&#39;https://www.plantuml.com/plantuml/svg/RSx12O8n38RXUwV80bb0HFuwWXl4Dc2X9jga-nliGP2Uy_3cEynf-7psb7ih37Y1gzvFaAS_MBmLygO2DtvFDaznCwg0mRv-0-sbOfnMZwp-ag911z0-lVwV4V_rld-mr9Zz0G00&#39;</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">&gt;</span></span></code></pre></div><h2 id="示例3-通过-gravizo-渲染-plantuml-源码" tabindex="-1">示例3：通过 Gravizo 渲染 PlantUML 源码 <a class="header-anchor" href="#示例3-通过-gravizo-渲染-plantuml-源码" aria-label="Permalink to &quot;示例3：通过 Gravizo 渲染 PlantUML 源码&quot;">​</a></h2><p><a href="https://www.gravizo.com/" target="_blank" rel="noreferrer">Gravizo</a> 支持在 URL 中直接携带 PlantUML 源码，适合在无法使用编码链接的场景下使用。</p><h3 id="_3-1-序列图-登录流程" tabindex="-1">3.1 序列图（登录流程） <a class="header-anchor" href="#_3-1-序列图-登录流程" aria-label="Permalink to &quot;3.1 序列图（登录流程）&quot;">​</a></h3><h4 id="效果-2" tabindex="-1">效果 <a class="header-anchor" href="#效果-2" aria-label="Permalink to &quot;效果&quot;">​</a></h4><p><img src="https://g.gravizo.com/svg?
@startuml;
participant User;
...
@enduml
"></p><h4 id="代码-2" tabindex="-1">代码 <a class="header-anchor" href="#代码-2" aria-label="Permalink to &quot;代码&quot;">​</a></h4><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>&lt;img src=&#39;https://g.gravizo.com/svg?</span></span>
...
Foo -&gt; Foo7: To queue;
@enduml
"></p><h4 id="代码-3" tabindex="-1">代码 <a class="header-anchor" href="#代码-3" aria-label="Permalink to &quot;代码&quot;">​</a></h4><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>&lt;img src=&#39;https://g.gravizo.com/svg?</span></span>
<span class="line"><span>@startuml</span></span>
...
g --&gt; UC3;
@enduml;
"></p><h4 id="代码-4" tabindex="-1">代码 <a class="header-anchor" href="#代码-4" aria-label="Permalink to &quot;代码&quot;">​</a></h4><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>&lt;img src=&#39;https://g.gravizo.com/svg?</span></span>
<span class="line"><span>@startuml;</span></span>
...
<span class="line"><span>@enduml;</span></span>
<span class="line"><span>&#39;&gt;</span></span></code></pre></div>`,32),l=[e];function o(i,c,r,h,d,u){return n(),s("div",null,l)}const b=a(p,[["render",o]]);export{m as __pageData,b as default};
