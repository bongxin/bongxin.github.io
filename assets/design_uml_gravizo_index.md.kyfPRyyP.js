import{_ as n,o as s,c as e,aQ as t}from"./chunks/framework.C8WmN7-d.js";const d=JSON.parse('{"title":"Gravizo","description":"","frontmatter":{"order":2},"headers":[],"relativePath":"design/uml/gravizo/index.md","filePath":"design/uml/gravizo/index.md"}'),p={name:"design/uml/gravizo/index.md"};function l(i,a,o,r,c,h){return s(),e("div",null,[...a[0]||(a[0]=[t(`<h1 id="gravizo" tabindex="-1">Gravizo <a class="header-anchor" href="#gravizo" aria-label="Permalink to &quot;Gravizo&quot;">​</a></h1><p>官网地址：<a href="https://www.gravizo.com/" target="_blank" rel="noreferrer">https://www.gravizo.com/</a></p><p>Gravizo 是一个绘图引擎，只需要用 Url 包含 PlantUML 代码放到一个 img 标签中，就可以在线实时的绘制出我们需要的 UML 图。</p><h2 id="示例1-支持plantuml语法" tabindex="-1">示例1：支持PlantUML语法 <a class="header-anchor" href="#示例1-支持plantuml语法" aria-label="Permalink to &quot;示例1：支持PlantUML语法&quot;">​</a></h2><h3 id="效果" tabindex="-1">效果 <a class="header-anchor" href="#效果" aria-label="Permalink to &quot;效果&quot;">​</a></h3><p><img src="https://g.gravizo.com/svg?
@startuml;
actor User;
...
<span class="line"><span>}</span></span></code></pre></div>`,23)])])}const u=n(p,[["render",l]]);export{d as __pageData,u as default};
