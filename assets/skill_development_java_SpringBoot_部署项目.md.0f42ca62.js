import{_ as s,c as a,o as n,b as l}from"./app.2ef68240.js";const A=JSON.parse('{"title":"部署项目","description":"","frontmatter":{},"headers":[],"relativePath":"skill/development/java/SpringBoot/部署项目.md","lastUpdated":1691078339000}'),p={name:"skill/development/java/SpringBoot/部署项目.md"},o=l(`<h1 id="部署项目" tabindex="-1">部署项目 <a class="header-anchor" href="#部署项目" aria-hidden="true">#</a></h1><h2 id="修改配置文件" tabindex="-1">修改配置文件 <a class="header-anchor" href="#修改配置文件" aria-hidden="true">#</a></h2><h3 id="application-druid-yml" tabindex="-1">application-druid.yml <a class="header-anchor" href="#application-druid-yml" aria-hidden="true">#</a></h3><p>修改数据库连接信息</p><div class="language-yml"><button title="Copy Code" class="copy"></button><span class="lang">yml</span><pre class="shiki material-palenight"><code><span class="line"><span style="color:#A6ACCD;"># 数据源配置</span></span>
