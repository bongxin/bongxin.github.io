import{_ as a,c as n,o as s,aS as e}from"./chunks/framework.BItddkxz.js";const q=JSON.parse('{"title":"Gravizo","description":"","frontmatter":{"order":2},"headers":[],"relativePath":"design/uml/gravizo/index.md","filePath":"design/uml/gravizo/index.md","lastUpdated":1772792710000}'),t={name:"design/uml/gravizo/index.md"},p=e(`<h1 id="gravizo" tabindex="-1">Gravizo <a class="header-anchor" href="#gravizo" aria-label="Permalink to &quot;Gravizo&quot;">​</a></h1><p>官网地址：<a href="https://www.gravizo.com/" target="_blank" rel="noreferrer">https://www.gravizo.com/</a></p><p>Gravizo 是一个绘图引擎，只需要用 Url 包含 PlantUML 代码放到一个 img 标签中，就可以在线实时的绘制出我们需要的 UML 图。</p><h2 id="示例1-支持plantuml语法" tabindex="-1">示例1：支持PlantUML语法 <a class="header-anchor" href="#示例1-支持plantuml语法" aria-label="Permalink to &quot;示例1：支持PlantUML语法&quot;">​</a></h2><h3 id="效果" tabindex="-1">效果 <a class="header-anchor" href="#效果" aria-label="Permalink to &quot;效果&quot;">​</a></h3><p><img src="https://g.gravizo.com/svg?
@startuml;
actor User;
...
<span class="line"><span>}</span></span></code></pre></div>`,23),l=[p];function i(o,r,c,h,g,d){return s(),n("div",null,l)}const v=a(t,[["render",i]]);export{q as __pageData,v as default};
