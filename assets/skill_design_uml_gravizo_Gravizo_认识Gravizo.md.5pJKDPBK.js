import{_ as a,c as s,o as n,aS as e}from"./chunks/framework.Cuoppmxr.js";const q=JSON.parse('{"title":"认识Gravizo","description":"","frontmatter":{"aside":"right"},"headers":[],"relativePath":"skill/design/uml/gravizo/Gravizo/认识Gravizo.md","filePath":"skill/design/uml/gravizo/Gravizo/认识Gravizo.md","lastUpdated":1720779746000}'),t={name:"skill/design/uml/gravizo/Gravizo/认识Gravizo.md"},p=e(`<h1 id="认识gravizo" tabindex="-1">认识Gravizo <a class="header-anchor" href="#认识gravizo" aria-label="Permalink to &quot;认识Gravizo&quot;">​</a></h1><p>官网地址：<a href="https://www.gravizo.com/" target="_blank" rel="noreferrer">https://www.gravizo.com/</a></p><p>Gravizo 是一个绘图引擎，只需要用 Url 包含 PlantUML 代码放到一个 img 标签中，就可以在线实时的绘制出我们需要的 UML 图。</p><h2 id="示例1-支持plantuml语法" tabindex="-1">示例1：支持PlantUML语法 <a class="header-anchor" href="#示例1-支持plantuml语法" aria-label="Permalink to &quot;示例1：支持PlantUML语法&quot;">​</a></h2><h3 id="效果" tabindex="-1">效果 <a class="header-anchor" href="#效果" aria-label="Permalink to &quot;效果&quot;">​</a></h3><p><img src="https://g.gravizo.com/svg?
@startuml;
actor User;
