  ...
  withSidebar(
    defineConfig({
      ...
      themeConfig: {
        ...
        editLink: {
          pattern: "https://github.com/bongxin/bongxin.github.io/edit/base/docs/:path",
